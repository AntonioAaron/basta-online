...
export default function Sala() {
    ...
    useEffect(() => {
        ...
        // Comparar que al menos un jugador responda
        const allSent = jugadoresIds.some((jid) => respuestasIds.includes(jid));
        setTodosEnviaron(allSent);
    }, [sala]);
...
>
  ...
  <h2 style={{ color: "#4a90e2" }}>Bienvenido, {sala.jugadores?.[jugadorId]?.nombre}</h2>
